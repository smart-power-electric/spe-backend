...
CREATE TABLE IF NOT EXISTS "main"."project_quotation" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "main"."main.project_quotation_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"project_id" integer,
	"material_id" integer,
	"service_id" integer,
	"quantity" integer,
